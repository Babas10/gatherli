...
void main() {
  ...
  group('Group Creation Flow', () {
    ...
    test('Creator is automatically added as member and admin', () async {
      // 1. Create and authenticate a test user
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
    ...
    test('Group with optional description stores correctly', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
    ...
    test('Group with description stores correctly', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
    ...
    test('Multiple groups can be created by same user', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
    ...
    test('Group name is stored and retrieved correctly', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
    ...
    test('Group creation sets timestamps correctly', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
