...
void main() {
  ...
  group('Registration Flow - Successful Registration', () {
    ...
    test('Registration returns valid user credential with UID', () async {
      final userCredential = await FirebaseAuth.instance
          .createUserWithEmailAndPassword(
  ...
  group('Registration Flow - Firestore Profile Creation', () {
    ...
    test('Auth UID matches Firestore document ID', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
  ...
  group('Registration Flow - Email Validation', () {
    ...
    test('Registration fails with empty email', () async {
      expect(
        () async => await FirebaseAuth.instance.createUserWithEmailAndPassword(
          email: '',
          password: 'password123',
    ...
    test('Registration fails with email missing domain', () async {
      expect(
        () async => await FirebaseAuth.instance.createUserWithEmailAndPassword(
          email: 'user@',
          password: 'password123',
    ...
    test('Registration fails with email missing username', () async {
      expect(
        () async => await FirebaseAuth.instance.createUserWithEmailAndPassword(
          email: '@test.com',
          password: 'password123',
  ...
  group('Registration Flow - Password Validation', () {
    ...
    test('Registration fails with empty password', () async {
      expect(
        () async => await FirebaseAuth.instance.createUserWithEmailAndPassword(
    ...
    test('Registration succeeds with exactly 6 character password', () async {
      final userCredential = await FirebaseAuth.instance
          .createUserWithEmailAndPassword(
    ...
    test('Registration succeeds with long password', () async {
      final userCredential = await FirebaseAuth.instance
          .createUserWithEmailAndPassword(
    ...
    test('Registration succeeds with special characters in password', () async {
      final userCredential = await FirebaseAuth.instance
          .createUserWithEmailAndPassword(
  ...
  group('Registration Flow - Email Verification', () {
    test('New user is created with unverified email', () async {
      final userCredential = await FirebaseAuth.instance
          .createUserWithEmailAndPassword(
    ...
    test('Verification email can be sent after registration', () async {
      final userCredential = await FirebaseAuth.instance
          .createUserWithEmailAndPassword(
  ...
  group('Registration Flow - Error Messages', () {
    test('Invalid email error has descriptive message', () async {
      try {
        await FirebaseAuth.instance.createUserWithEmailAndPassword(
          email: 'invalid',
          password: 'password123',
    ...
    test('Weak password error has descriptive message', () async {
      try {
        await FirebaseAuth.instance.createUserWithEmailAndPassword(
  ...
  group('Registration Flow - Complete User Creation', () {
    ...
    test('Multiple users can register with unique emails', () async {
      // Register user 1
    ...
    test('User can query their own document after registration', () async {
      final user = await FirebaseEmulatorHelper.createCompleteTestUser(
