...
void main() {
  ...
  group('Invitation Acceptance Flow', () {
    test('User can accept invitation and join group', () async {
    ...
    test('Only invited user can accept their own invitation', () async {
      // 1. Create users
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
    ...
    test('User cannot modify groupId or invitedBy when accepting', () async {
      // 1. Create users and group
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
    ...
    test('Accepted invitation removes from pending queries', () async {
      // 1. Create users and group
      final admin = await FirebaseEmulatorHelper.createCompleteTestUser(
        email: 'admin@test.com',
        password: 'password123',
