...
void main() {
  ...
  testWidgets('Participant sees "Enter Results" button when game is past', (
    tester,
  ) async {
  ...
  testWidgets(
    'Participant does NOT see "Enter Results" button when game is future',
    (tester) async {
  ...
  testWidgets(
    'Creator does NOT see "Enter Results" button when game is future',
    (tester) async {
      final futureGame = baseGame.copyWith(
        scheduledAt: DateTime.now().add(const Duration(hours: 2)),
      );
  ...
  testWidgets(
    'Participant sees "Enter Results" button when game is in progress',
    (tester) async {
  ...
  testWidgets(
    'Outsider does NOT see "Enter Results" button even when game is past',
    (tester) async {
      final pastGame = baseGame.copyWith(
        scheduledAt: DateTime.now().subtract(const Duration(hours: 2)),
      );
  ...
  testWidgets('"Enter Results" button navigates to ScoreEntryPage', (
    tester,
  ) async {
    final pastGame = baseGame.copyWith(
      scheduledAt: DateTime.now().subtract(const Duration(hours: 2)),
  ...
  testWidgets(
    'Participant does NOT see "Enter Results" when game has insufficient players',
    (tester) async {
      ...
      await tester.pumpWidget(
        createWidgetUnderTest(insufficientPlayersGame.id),
      );
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'Creator does NOT see "Enter Results" when game has insufficient players',
    (tester) async {
      final insufficientPlayersGame = baseGame.copyWith(
        scheduledAt: DateTime.now().subtract(const Duration(hours: 2)),
        minPlayers: 4,
  ...
  testWidgets(
    'Participant sees "Enter Results" when game is past with enough players',
    (tester) async {
