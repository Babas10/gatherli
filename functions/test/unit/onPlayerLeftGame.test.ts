// Unit tests for onPlayerLeftGame — notification removed in Story N.2.
...
describe("onPlayerLeftGame Cloud Function", () => {
  it("no longer sends notifications (Story N.2 — low-signal noise reduction)", () => {
    // The onPlayerLeftGame Cloud Function was intentionally removed.
    // Player-left notifications were too frequent and low-value.
