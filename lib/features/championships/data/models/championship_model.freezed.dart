...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,status,maxTeams,teamSize,const DeepCollectionEquality().hash(adminIds),createdBy,createdAt,registrationDeadline,currentRound,totalRounds,teamsCount,startDate,country,region);

@override
String toString() {
  return 'ChampionshipModel(id: $id, title: $title, status: $status, maxTeams: $maxTeams, teamSize: $teamSize, adminIds: $adminIds, createdBy: $createdBy, createdAt: $createdAt, registrationDeadline: $registrationDeadline, currentRound: $currentRound, totalRounds: $totalRounds, teamsCount: $teamsCount, startDate: $startDate, country: $country, region: $region)';
}
...
switch (_that) {
case _ChampionshipModel() when $default != null:
return $default(_that.id,_that.title,_that.status,_that.maxTeams,_that.teamSize,_that.adminIds,_that.createdBy,_that.createdAt,_that.registrationDeadline,_that.currentRound,_that.totalRounds,_that.teamsCount,_that.startDate,_that.country,_that.region);case _:
  return orElse();
...
class _ChampionshipModel extends ChampionshipModel {
  const _ChampionshipModel({required this.id, required this.title, this.status = ChampionshipStatus.registration, this.maxTeams = 10, this.teamSize = 2, final  List<String> adminIds = const [], required this.createdBy, @TimestampConverter() required this.createdAt, @TimestampConverter() required this.registrationDeadline, this.currentRound = 0, this.totalRounds = 9, this.teamsCount = 0, @NullableTimestampConverter() this.startDate, this.country, this.region}): _adminIds = adminIds,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,status,maxTeams,teamSize,const DeepCollectionEquality().hash(_adminIds),createdBy,createdAt,registrationDeadline,currentRound,totalRounds,teamsCount,startDate,country,region);
